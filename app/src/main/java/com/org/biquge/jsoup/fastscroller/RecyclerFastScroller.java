package com.org.biquge.jsoup.fastscroller;
...
public class RecyclerFastScroller extends FrameLayout {
    ...
    public void setTouchTargetWidth(int touchTargetWidth) {
        ...
        int twenty = RecyclerFastScrollerUtils.convertDpToPx(getContext(), 20);
        mBarInset = mTouchTargetWidth - twenty;

        int fiftySix = RecyclerFastScrollerUtils.convertDpToPx(getContext(), 56);
        if (mTouchTargetWidth > fiftySix) {
